...
public class PxFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup viewGroup, Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.rd_layout, null);recyclerView = (RecyclerView) view.findViewById(R.id.recyclerView);
        RdPxList[] rdPxLists = new RdPxList[]{
                new RdPxList("Email", "123"),
                new RdPxList("Info", "12"),
                new RdPxList("Injjfo", "12322"),
        };
